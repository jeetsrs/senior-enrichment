...
export default class SingleCampus extends Component {
  ...
  handleChangeCampusName(evt){
    evt.preventDefault();
    this.setState({campus: {name: evt.target.CampusName.value}});
  }
  handleChangeCampusURL(evt){
    evt.preventDefault();
    this.setState({campus: {imgURL: evt.target.CampusURL.value}});
  }
  handleSubmit (evt) {
    evt.preventDefault();
    const campus = {
      ...
      imgURL: evt.target.CampusURL.value
    };
    const updateCampus = updateCampusThunk(campus);
  ...
  render () {
    ...
    const campus = campuses.find(campus => (campus.id === +this.props.match.params.id) ? campus : null );
